                    ...
                    <div class="card-body">
                        <form @submit.prevent="updateEmployee">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input v-model="form.first_name" id="first_name" type="text" class="form-control" required autocomplete="first_name" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input v-model="form.middle_name" id="middle_name" type="text" class="form-control" required autocomplete="middle_name" autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input v-model="form.last_name" id="last_name" type="text" class="form-control" required autocomplete="last_name" autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input v-model="form.address" id="address" type="text" class="form-control" required autocomplete="address" autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="department" class="col-md-4 col-form-label text-md-right">Depatment</label>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input v-model="form.zip_code" id="zip_code" type="text" class="form-control" required autocomplete="zip_code" autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="date_hired" class="col-md-4 col-form-label text-md-right">Date Of Hire</label>
                                <div class="col-md-6">
