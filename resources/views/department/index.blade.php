                    ...
                    <div class="col">
                        <form method="GET" action="{{ route('department.index')}}">
                            <div class="form-row align-items-center">
                              <div class="col">
                                <input type="search" name="search" class="form-control mb-2" id="inlineFormInput" placeholder="Web">
                              </div>
                              <div class="col">
                    ...
                    <tbody>
                      @foreach ($department as $name )
                        ...
                        <tr>
                            ...
                            <td>{{$name->name}}</td>
                            <td>
                                <a href="{{route('department.edit', $name->id)}}" class="btn btn-success">Edit</a>
                            </td>
                        </tr>
